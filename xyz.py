    ...
    def show_dose_block(self):
        ...
        if self.selected:
            ...
            with st.expander(section_title):
                ...
                self.inputs["Meteorological Data Provided"] = has_meta
                ...
                if st.session_state.get("run_triggered", False):
                    ...
                    st.download_button(
                        "📘 Download YAML Input Log",
                        data=yaml_data,
                        file_name="input_log.yaml",
                        mime="text/yaml"
                    )

                    st.download_button("🗂️ Download Log File", data="Sample Log Content", file_name="pydoseia_log_file.txt")
                    st.download_button("📊 Download Output File", data="Sample Output Content", file_name="pydoseia_out_file.txt")
        else:
